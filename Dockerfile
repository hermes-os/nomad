...
# Labels
LABEL org.opencontainers.image.title="Nomad" \
      org.opencontainers.image.description="The official Nomad Docker image" \
      org.opencontainers.image.version="${VERSION}" \
      org.opencontainers.image.created="${BUILD_DATE}" \
      org.opencontainers.image.revision="${VCS_REF}" \
      org.opencontainers.image.vendor="Crosstalk Solutions, LLC" \
      org.opencontainers.image.documentation="https://github.com/hermes-os/nomad/blob/main/README.md" \
      org.opencontainers.image.source="https://git.ashwren.com/hermes/nomad" \
