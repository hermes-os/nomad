      ...
      <div className="xl:pl-72 w-full">
        <main className="px-6 lg:px-12 py-6 lg:py-8">
          <div className="mb-8">
            ...
            <p className="text-desert-stone-dark">
              Keep your Nomad instance up to date with the latest features and
              improvements.
            </p>
          </div>
                ...
                <>
                  ...
                  <p className="text-desert-stone-dark mb-6">
                    {props.system.updateAvailable
                      ? `A new version (${props.system.latestVersion}) is available for your Nomad instance.`
            ...
            <div className="flex flex-col md:flex-row justify-between items-center p-8 gap-y-8 md:gap-y-0 gap-x-8">
              <div>
                <h2 className="max-w-xl text-lg font-bold text-desert-green sm:text-xl lg:col-span-7">
                  Want to stay updated with the latest from Nomad? Subscribe to receive
              ...
              <div className="flex flex-col">
                ...
                <p className="mt-2 text-sm text-desert-stone-dark">
                  We care about your privacy. Nomad will never share your email with
