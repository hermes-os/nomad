...
### Bug Fixes
- **Security**: Settings keys are now validated against the known settings schema; requests writing unknown or non-settings keys are rejected with a validation error instead of reaching the store
